...
public class ReleaseController {
	...
	public HttpEntity<PagedResources<ReleaseResource>> customSearch( //
	...
	@GetMapping
	public HttpEntity<PagedResources<ReleaseResource>> search( //
	...
	public ResponseEntity<ReleaseResource> findOne(@PathVariable final String releaseId) {
	...
	@PostMapping
	public ResponseEntity<ReleaseResource> create(@Valid @RequestBody final ReleaseDto releaseDto) {
	...
	public ResponseEntity<ReleaseResource> update(@PathVariable final String releaseId, @Valid @RequestBody final ReleaseDto releaseDto) {
		final Optional<Release> releaseOpt = releaseService.update(releaseId, releaseDto);

		return releaseOpt.map(release -> new ResponseEntity<>(releaseResourceAssembler.toResource(release), HttpStatus.OK)).orElseGet(() -> ResponseEntity.notFound().build());
	}
